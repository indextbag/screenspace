...
MString CustomShape::typeName = "custom";
MTypeId CustomShape::id(0x8702F);

MObject CustomShape::m_camera;
MObject CustomShape::m_shape;
MObject CustomShape::m_color;
MObject CustomShape::m_opacity;
MObject CustomShape::m_size;
MObject CustomShape::m_width;
MObject CustomShape::m_height;
MObject CustomShape::m_depth;
MObject CustomShape::m_position;
MObject CustomShape::m_horizontalAlign;
MObject CustomShape::m_verticalAlign;
MObject CustomShape::m_offsetX;
MObject CustomShape::m_offsetY;
MObject CustomShape::m_offset;

void* CustomShape::creator() {
  return new CustomShape();
}

MStatus CustomShape::initialize() {
